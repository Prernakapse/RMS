      ...
      <div class="container">
        <div class="row">
          <div class="col-12">
            ...
            <form  method="POST"  action="<?php echo base_url().'Booking/submit';?>"class="position-relative">
              <img data-aos="fade-down-left" class="d-none d-lg-blosck" src="./assets/images/reservation-showcase.png"
                alt="">
              ...
              <div class="row mt-5">
                <div data-aos="fade-right" class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control bg-transparent border-0 px-3" name="phone" value="<?php echo set_value('phone') ?>" type="text" placeholder="Phone">
                  </div>
                  <div class="input-group">
                    <div class="icon-wrapper d-flex align-items-center position-relative">
                ...
                <div data-aos="fade-left" class="col-md-6">
                  ...
                  <select class="form-select bg-transparent border-0 ps-3" name="person">
                      <option value="">Select Number of Persons</option>
                      <option value="1" <?php echo set_select('person', '1'); ?>>1 Person</option>
                      <option value="2" <?php echo set_select('person', '2'); ?>>2 Persons</option>
                      <option value="3" <?php echo set_select('person', '3'); ?>>3 Persons</option>
                      <option value="4" <?php echo set_select('person', '4'); ?>>4 Persons</option>
                      <option value="5" <?php echo set_select('person', '5'); ?>>5 Persons</option>
                      <option value="6" <?php echo set_select('person', '6'); ?>>6 Persons</option>
                      <option value="7" <?php echo set_select('person', '7'); ?>>7 Persons</option>
                      <option value="8" <?php echo set_select('person', '8'); ?>>8 Persons</option>
                      <option value="9" <?php echo set_select('person', '9'); ?>>9 Persons</option>
                      <option value="10" <?php echo set_select('person', '10'); ?>>10 Persons</option>
                  </select>
                  ...
                  <div class="input-group">
                    ...
                    <select type="time" placeholder="Time" name="time" value="<?php echo set_value('time') ?>"  class="ps-3 form-select bg-transparent border-0">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="input-group" data-aos="fade-up-right">
                    <textarea class="form-control bg-transparent border-0 px-3" name="message" value="<?php echo set_value('message') ?>" id=""
                      placeholder="Description"></textarea>
                  </div>
                </div>
              </div>
                <button type="submit" value="send" >Book Table</button>
        ...
        <div class="row">
          <div data-aos="fade-right" class="col-lg-6 mb-5 pb-5 mb-lg-0 pb-lg-0">
            <div class="event-card position-relative">
              ...
              <div class="image">
                <img class="img-fluid" src="./assets/images/event-01.jpg" alt="">
              </div>
          ...
          <div data-aos="fade-left" class="col-lg-6">
            <div class="event-card position-relative">
              ...
              <div class="image">
                <img class="img-fluid" src="./assets/images/event-02.jpg" alt="">
              </div>
              <div class="event-info position-absolute">
                <ul class="d-flex justify-content-around ps-lg-0 position-relative my-3">
                  <li class="list-unstyled">
