header.scrolled .menus>ul>li::after {
    ...
    .shopping-cart-header {
      padding: 16px 18px;
      box-shadow: 7px 5px 15px -4px rgba(0, 0, 0, 0.1);
    }
    ...
    .shopping-cart-item .item-price p,
    .shopping-cart-footer .footet-total-price {
      font-family: "Pacifico", cursive;
      font-size: 18px;
      color: var(--primary-color);
    }
    ...
    .footer-checkout:hover>.anim-layer,
    .footer-shopping:hover>.anim-layer {
      width: 100%;
      left: 0;
      right: auto;
    }

    .footer-checkout:hover a,
    ...
    /* about us start */
    .about-us {
      background-image: url('<?php echo base_url('assets/images/about-bg.jpg') ?>');
    ...
    @media (max-width: 990px) {
      .slider-indicators-wrapper .slider-indicators {
        display: flex;
        flex-direction: column;
        /* Stack indicators vertically on smaller screens */
        align-items: center;
      }
    ...
    .slider-indicators-wrapper .slider-indicators.slick-current .indicators-icon>i,
    ...
    .testimonials {
      ...
      background-image: url("<?php echo base_url('assets/images/testi-bg.jpg') ?>");
    ...
    .testimonials .testimonial-slider-wrapper .slider-content .testi-content::before {
      content: "\f10d";
    ...
    .testimonials .testimonial-slider-wrapper .slider-content .testi-info .position {
      margin-left: 3px;
      color: #a6a6a6;
      position: relative;
      padding-left: 10px;
    ...
    .testimonials .testimonial-slider-wrapper .slider-content .testi-info .position::before {
      content: "|";
      position: absolute;
      right: 100%;
      width: 2px;
    ...
    .testimonials .testimonial-slider-wrapper .slider-nav .slider-nav-img.slick-current img,
  ...
  transition: all 0.3s linear;
    ...
    .gallery-image-one {
      background-image: url("<?php echo base_url('assets/images/gallery-1.jpg'); ?>");
    }
    ...
    .gallery-image-two {
      ...
      height: 325px;
      background-position: center;
      background-image: url("<?php echo base_url('assets/images/gallery-2.jpg'); ?>");
    }
    ...
    .gallery-image-three {
      ...
      height: 325px;
      background-position: center;
      background-image: url("<?php echo base_url('assets/images/gallery-3.jpg'); ?>");
    }

    .gallery-image-four {
      background-image: url("<?php echo base_url('assets/images/gallery-4.jpg'); ?>");
    }
    ...
    .gallery-image-five {
      ...
      height: 325px;
      background-position: center;
      background-image: url("<?php echo base_url('assets/images/gallery-5.jpg'); ?>");
    }
    ...
    .gallery-image-six {
      ...
      height: 325px;
      background-position: center;
      background-image: url("<?php echo base_url('assets/images/gallery-6.jpg'); ?>");
    }
    ...
    footer {
      ...
      background-image: url("<?php echo base_url('assets/images/footer-bg.jpg'); ?>");
    }
    ...
    .reservation-box {
      ...
      background-image: url("<?php echo base_url('assets/images/ft-res-bg.jpg'); ?>");
      padding: 25px;
    }
    ...
    .page-banner {
      ...
      background-image: url("<?php echo base_url('assets/images/pagetitle-contact.jpg'); ?>");
    ...
    .contact-page .contact-us .contact-info .contact-info-box:hover .contact-icon-box {
      background-color: var(--primary-color);
      box-shadow: 0 0 20px rgba(0, 0, 0, 0.2);
    }

    .contact-page .contact-us .contact-info .contact-info-box:hover .contact-icon-box i {
      color: white;
    }
    ...
    .reservation-page .banner {
      ...
      background-image: url("<?php echo base_url('assets/images/pagetitle-reservation.jpg'); ?>");
    ...
    .reservation-page .reservation-services {
      ...
      background-image: url("<?php echo base_url('assets/images/reservation-services-bg.jpg'); ?>");
    ...
    .reservation-page .reservation-events .event-card .event-info {
      ...
      background-image: url("<?php echo base_url('assets/images/event-01.jpg'); ?>");
    ...
    .about-page .our-special .special-card:hover {
      ...
      background-image: url("<?php echo base_url('assets/images/featured-box-bg-1.jpg'); ?>");
    ...
    .menu-page .page-banner {
      ...
      background-image: url(<?php echo base_url('assets/images/pagetitle-menu.jpg'); ?>);
      /* <img src="<?php echo base_url('assets/images/pagetitle-menu.jpg'); ?>" alt="" /> */
    }
